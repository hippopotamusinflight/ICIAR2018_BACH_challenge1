#!/bin/bash 
#SBATCH --job-name=predict_ICIAR_testset_p600s200_resnet50_155epochs
...
job_name="predict_ICIAR_testset_p600s200_resnet50_155epochs" 
...
python ${ICIAR_dir}predict_ICIAR_testset_p600s200_resnet50_155epochs.py
