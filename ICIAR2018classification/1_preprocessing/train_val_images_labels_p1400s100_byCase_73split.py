...
all_patches_dir = os.path.join(photos_dir, "all_patches1400/")
patches_labels_path = os.path.join(all_patches_dir, "patches_and_label_1400_stride100.csv")
...
#                 test_image_arr_list.append(img_RGB_resz)
    ...
    np.save("./X_train_1400_byCase_70_30_split", X_train)
    np.save("./y_train_1400_byCase_70_30_split", y_train)
    
    X_val = np.array(val_image_arr_list)
    y_val = np.array(val_label_list)
    y_val = np_utils.to_categorical(y_val)
    np.save("./X_val_1400_byCase_70_30_split", X_val)
    np.save("./y_val_1400_byCase_70_30_split", y_val)      
