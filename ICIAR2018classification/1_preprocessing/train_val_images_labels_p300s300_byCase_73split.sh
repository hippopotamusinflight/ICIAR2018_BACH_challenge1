#!/bin/bash 
#SBATCH --job-name=train_val_test_images_labels_patches300_byCase_70_30_split
...
job_name="train_val_test_images_labels_patches300_byCase_70_30_split" 
...
python ${ICIAR_dir}train_val_images_labels_p300s300_byCase_73split.py
