#!/bin/bash 
#SBATCH --job-name=train_val_images_labels_wholeImage_byCase_73split
...
job_name="train_val_images_labels_wholeImage_byCase_73split" 
...
python ${ICIAR_dir}train_val_images_labels_wholeImage_byCase_73split.py
