#!/bin/bash 
#SBATCH --job-name=train_val_test_images_labels_patches1400_byCase_70_30_split
...
job_name="train_val_test_images_labels_patches1400_byCase_70_30_split" 
...
python ${ICIAR_dir}train_val_images_labels_p1400s100_byCase_73split.py
