#!/bin/bash
#SBATCH --job-name=CNN9L_imgaug_p300s300_es_mc_73split
...
job_name="CNN9L_imgaug_p300s300_es_mc_73split"
...
python ${ICIAR_dir}CNN9L_imgaug_p300s300_es_mc_73split.py
