#!/bin/bash
#SBATCH --job-name=ResNet50_wDropout_p600s200_73split_es_mc_100moreEpochs_GPU
...
job_name="ResNet50_wDropout_p600s200_73split_es_mc_100moreEpochs_GPU"
...
python ${ICIAR_dir}ResNet50_wDropout_p600s200_73split_es_mc_100moreEpochs.py
