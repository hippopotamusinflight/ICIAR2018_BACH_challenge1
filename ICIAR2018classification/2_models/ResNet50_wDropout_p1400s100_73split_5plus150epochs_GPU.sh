#!/bin/bash
#SBATCH --job-name=ResNet50_wDropout_p1400s100_73split_5plus150epochs_GPU
...
job_name="ResNet50_wDropout_p1400s100_73split_5plus150epochs_GPU"
...
python ${ICIAR_dir}ResNet50_wDropout_p1400s100_73split_5plus150epochs.py
