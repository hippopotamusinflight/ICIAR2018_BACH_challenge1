...
model_name = "CNN9L_imgaug_p300s300_es_mc_73split_300epochs_bs128_100pat_lr4"
...
H = model.fit_generator(
    ...
    steps_per_epoch=len(X_train) // batch_size,                 # 11661*0.9//256 =
...
# saving model
# model.save("./outputs/" + model_name + ".h5")
