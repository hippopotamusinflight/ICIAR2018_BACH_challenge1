#!/bin/bash
#SBATCH --job-name=ResNet50_wDropout_p300s300_73split_es_mc_100moreEpochs
...
job_name="ResNet50_wDropout_p300s300_73split_es_mc_100moreEpochs"
...
python ${ICIAR_dir}ResNet50_wDropout_p300s300_73split_es_mc_100moreEpochs.py
