#!/bin/bash
#SBATCH --job-name=ResNet50_wDropout_p600s200_73split_CPU
...
job_name="ResNet50_wDropout_p600s200_73split_CPU"
...
python ${ICIAR_dir}ResNet50_wDropout_p600s200_73split.py
