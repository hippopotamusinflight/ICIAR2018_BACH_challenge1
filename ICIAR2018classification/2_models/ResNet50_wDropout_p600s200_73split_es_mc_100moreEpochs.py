# ResNet50_wDropout_p600s200_73split_es_mc_100moreEpochs.py

'''
change model_name, model_fname, (data_dir), data npys
'''

model_name = "ResNet50_wDropout_p600s200_73split_es_mc_100moreEpochs"
...
X_train = np.load(os.path.join(data_dir,"X_train_p600s200_byCase_73split.npy"))
y_train = np.load(os.path.join(data_dir,"y_train_p600s200_byCase_73split.npy"))
X_val = np.load(os.path.join(data_dir,"X_val_p600s200_byCase_73split.npy"))
y_val = np.load(os.path.join(data_dir,"y_val_p600s200_byCase_73split.npy"))
class_num = 4
...
model_fname = "ResNet50_wDropout_p600s200_73split_v1.h5"
